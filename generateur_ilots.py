...
# On crée un classificateur SVM linéaire
...
accuracy = accuracy_score(y_test, y_pred) # Precision = Nombre d'observations correctement prédites / Nombre total d'observations 
